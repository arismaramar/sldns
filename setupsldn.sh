#!/bin/bash
wget -O anggunhostdns.sh https://raw.githubusercontent.com/arismaramar/sldns/main/anggunhostdns.sh && chmod +x anggunhostdns.sh && ./anggunhostdns.sh
...
cd
#wget -q -O /etc/systemd/system/client-sldns.service "https://raw.githubusercontent.com/arismaramar/sldns/main/slowdns/client-sldns.service"
#wget -q -O /etc/systemd/system/server-sldns.service "https://raw.githubusercontent.com/arismaramar/sldns/main/slowdns/server-sldns.service"
cd
